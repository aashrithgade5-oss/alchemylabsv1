...
export const SolutionsHub = () => {
  ...
  return (
    <div className="min-h-screen bg-background grain-overlay">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          <ScrollReveal>
            <div className="max-w-4xl">
              ...
              <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] tracking-display text-porcelain mb-8 text-balance">
                Three pillars.
                <br />
                        ...
                        <div className="relative glass-deep rounded-2xl p-8 md:p-12 flex flex-col md:flex-row md:items-center gap-8 group-hover:border-alchemy-red/20 transition-colors duration-300">
                          ...
                          <div className="flex items-center gap-6 flex-1">
                            ...
                            <div className="flex-1">
                              <h3 className="font-display text-3xl md:text-4xl italic text-porcelain group-hover:text-alchemy-red transition-colors duration-300 mb-1 text-balance">
                                {pillar.title}
                              </h3>
      ...
      <section className="relative py-24 luxury-margin">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <SpotlightContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <SpotlightItem key={service.id} id={service.id}>
                  <ScrollReveal delay={i * 0.1}>
                    <Link
                      ...
                      className="block p-6 rounded-2xl glass group hover:border-alchemy-red/30 transition-all duration-300 h-full"
                    >
                      ...
                      <h4 className="font-display text-xl italic text-porcelain group-hover:text-alchemy-red transition-colors mb-2 text-balance">
                        {service.title}
                      </h4>
      ...
      {/* Sprint CTA */}
      <section className="relative py-24 overflow-hidden luxury-margin">
        <div className="absolute inset-0 pointer-events-none">
