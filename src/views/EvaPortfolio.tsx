            ...
            <div className="relative z-10 flex flex-col h-full px-8 pt-24 pb-12">
              ...
              <div className="flex-1 flex flex-col justify-center gap-6">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.4, ease: EASE }}>
                  <Link href="/about" onClick={() => setIsOpen(false)} className={`inline-flex items-center gap-2 font-mono text-sm ${t(isDark, 'text-porcelain/50', 'text-neutral-500')} hover:text-pink-500 transition-colors mt-4`}>
